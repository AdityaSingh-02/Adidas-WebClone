    ...
    return (
        <>
            <div className='w-screen flex md:flex-row flex-col-reverse'>
                <div className='md:w-[50%] w-[217vw] bg-[#f04b4f] h-[92vh] pl-16 flex justify-center flex-col text-white'>
                ...
                <div className='md:w-[50%] w-[217vw]'>
                    <Image src={'/MainPageImg.png'} placeholder='empty' width={2000} height={500} />
                </div>
            </div>
        </>
    )
